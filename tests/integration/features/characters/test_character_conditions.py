...
class TestCharacterConditions:
    def test_add_and_list_condition(self, client, player, player_token, create_class, create_character):
    ...
    def test_add_exhaustion_without_level_returns_422(
    ...
    def test_add_exhaustion_with_level(self, client, player, player_token, create_class, create_character):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
    ...
    def test_add_level_to_non_exhaustion_condition_returns_422(
        self, client, player, player_token, create_class, create_character
    ):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
    ...
    def test_add_unknown_condition_returns_422(self, client, player, player_token, create_class, create_character):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
    ...
    def test_duplicate_condition_returns_409(self, client, player, player_token, create_class, create_character):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
    ...
    def test_update_exhaustion_level(self, client, player, player_token, create_class, create_character):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
        client.post(
            f"/characters/{character.id}/conditions",
    ...
    def test_update_non_exhaustion_condition_with_level_returns_400(
        self, client, player, player_token, create_class, create_character
    ):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
    ...
    def test_remove_condition(self, client, player, player_token, create_class, create_character):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
        client.post(
            f"/characters/{character.id}/conditions",
    ...
    def test_player_cannot_add_condition_to_other_players_character(
