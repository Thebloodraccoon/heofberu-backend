...
class TestCharacterSkillProficiencies:
    def test_replace_skill_proficiencies(
        ...
        skill = create_skill(key="ATHLETICS", name="Athletics", ability="STR")
    ...
    def test_clear_skill_proficiencies(
        self, client, player, player_token, create_class, create_character, create_skill
    ):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
    ...
    def test_invalid_skill_id_returns_400(self, client, player, player_token, create_class, create_character):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
    ...
    def test_player_cannot_edit_other_players_character(
...
class TestCharacterSavingThrowProficiencies:
    def test_replace_saving_throws(self, client, player, player_token, create_class, create_character):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
    ...
    def test_clear_saving_throws(self, client, player, player_token, create_class, create_character):
        character_class = create_class(name="Fighter")
        character = create_character(owner_id=player.id, class_id=character_class.id)
