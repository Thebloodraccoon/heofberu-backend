...
async def register(request: RegisterRequest, response: Response, auth_service: AuthServiceDep):
    """
...
async def login(request: LoginRequest, response: Response, auth_service: AuthServiceDep):
    """
...
async def logout(
    ...
    logout_response = await auth_service.logout(decoded_access_token, refresh_token_str)
