...
from app.features.items.schemas import SourceItemResponse, SourceItemsUpdate
...
async def list_background_items(background_id: int, background_service: BackgroundServiceDep):
