...
class CharacterFeatureService(CharacterSubDomainService):
    ...
    async def update_feature(
        ...
        grant = await self._get_grant_or_404(character_id, character_feature_id)
    ...
    async def _get_grant_or_404(self, character_id: int, character_feature_id: int) -> CharacterFeature:
