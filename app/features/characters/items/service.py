...
class CharacterItemService(CharacterSubDomainService):
    ...
    async def update_item(
        ...
        updated_stack = await self.character_item_repository.update(stack, update_data, refresh=True)
    ...
    async def remove_item(self, character_id: int, character_item_id: int, current_user: UserResponse) -> bool:
        ...
        stack = await self._get_stack_or_404(character_id, character_item_id)
        return await self.character_item_repository.remove_character_item(stack)
