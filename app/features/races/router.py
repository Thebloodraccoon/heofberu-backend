...
subdomain mounts under the same prefix: ``/races/{race_id}/subraces/...``.
...
from app.features.races.subraces.router import router as subraces_router
...
router.include_router(subraces_router, prefix="/races")
