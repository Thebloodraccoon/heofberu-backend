...
class SubraceCrudService(
    ...
    async def get_subrace(self, race_id: int, subrace_id: int) -> SubraceFullResponse:
        """Race-scoped variant of :meth:`get_by_id`: 404s if the subrace belongs to a different race."""
