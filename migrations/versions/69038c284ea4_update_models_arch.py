...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "size",
            postgresql.ENUM(
                "TINY", "SMALL", "MEDIUM", "LARGE", "HUGE", "GARGANTUAN", name="race_size", create_type=False
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "range_type",
            postgresql.ENUM(
                "SELF", "TOUCH", "RANGED", "SIGHT", "UNLIMITED", name="spell_range_type", create_type=False
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            "attack_type",
            postgresql.ENUM("MELEE_ATTACK", "RANGED_ATTACK", name="attack_type", create_type=False),
            nullable=True,
        ),
        sa.Column(
            "save_stat",
